    ...
    <div class="contenedor-form">
        ...
        <form method="POST" action="/RegistrarLibro">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="txtTitulo" class="form-control" id="exampleInputPassword1"
                    value= "{{ old('txtTitulo') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="txtEmaileditorial" class="form-control"
                    value= "{{ old('txtEmaileditorial') }}">
